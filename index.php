...
<div class="mySlides fade">
  <img src="https://images.unsplash.com/photo-1557234195-bd9f290f0e4d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80" style="width:100%">
   <button class="rbtn" onclick="document.getElementById('id01').style.display='block'" style="width:auto">LOGIN</button>
  <button class="lbtn" onclick="document.getElementById('id02').style.display='block'" style="width:auto">REGISTER</button>

   
</div></div>
  <div class="text"><h1><b>welcome to farmersworld.in <br>Register with us to get services<br> Farmers are the backbone of our country<br>support them & help them by</b></h1></div>
</div></div>
...
<div class="mySlides fade">
  ...
  <img src="https://agriculturalinformation4u.com/wp-content/uploads/2018/01/specialized-farming-2.jpg" style="width:100%">
  <button class="rbtn" onclick="document.getElementById('id01').style.display='block'" style="width:auto">LOGIN</button>
  <button class="lbtn" onclick="document.getElementById('id02').style.display='block'" style="width:auto">REGISTER</button>

   <div class="text1"><h2>Machinery also Available for rent..... <h2></div></div></div>
...
<div class="mySlides fade">
  ...
  <img src="https://www.tradelinkinternational.com/sa/wp-content/uploads/2020/10/agriculture-problems-scaled.jpg" style="width:100%">
  <button class="rbtn" onclick="document.getElementById('id01').style.display='block'" style="width:auto">LOGIN</button>
  <button class="lbtn" onclick="document.getElementById('id02').style.display='block'" style="width:auto">REGISTER</button>
<div class="text1"></h2>Buy products directly from them...</h2></div></div>
